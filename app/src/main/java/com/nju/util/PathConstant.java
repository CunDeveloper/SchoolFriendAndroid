...
public interface PathConstant {
    ...
    String ALUMNI_TALK_SUB_PATH_GET_OTHER_ALUMNI_TALKS = "viewTalksByAuthorId";
    ...
    String USER_DEGREE_QUERY_OTHER_AUTHOR = "queryOtherAuthorDegree";
    ...
    String RECOMMEND_WORK_SUB_PATH_GET_BYAUTHOR_ID = "getRecommendsByAuthorId";
    ...
    String ALUMNIS_VOICE_SUB_PATH_GET_VOICES_BY_AUTHORID = "getVoicesByAuthorId";
    ...
    String ALUMNIS_QUESTION_SUB_PATH_GET_BYAUTHOR_ID = "viewAlumniQuestionsByAuthorId";
