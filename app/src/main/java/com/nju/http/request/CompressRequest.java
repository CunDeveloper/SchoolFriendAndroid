 ...
 */
public class CompressRequest implements Callable<BitmaWrapper> {
    private static int mWidth = 0;
    private static int mHeight = 0;
    private static final int DEFAULT_WIDTH = 720;
    private static final int DEFAULT_HEIGHT = 1000;
    private final  BitmaWrapper mBitmapWraper;
    private final Context mContext;

    public CompressRequest(Context context,BitmaWrapper bitmaWrapper) {
        ...
        mBitmapWraper = bitmaWrapper;
        mContext = context;
    }

    @Override
    public BitmaWrapper call() throws Exception {
